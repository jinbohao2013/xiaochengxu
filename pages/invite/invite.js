...
Page({
  ...
  onLoad: function (options) {
    ...
    if (wx.getStorageSync("usertype")=="2") {
      ...
      shareUrl = "https://www.yqcoffee.cn/userbind/?distributorid=" + wx.getStorageSync("fenxiaoshangid") + "&state=1" + "&uid=" + wx.getStorageSync("userid");
    } else if (wx.getStorageSync("usertype") == "3"){
      //申请分销员的链接，后面的参数是经销商的id和店长的id
      shareUrl = "https://www.yqcoffee.cn/usebind/?distributorid=" + wx.getStorageSync("fenxiaoshangid") + "&shopid=" + wx.getStorageSync("shopid") + "&uid=" + wx.getStorageSync("userid");
