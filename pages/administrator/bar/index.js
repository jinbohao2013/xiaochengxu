...
Page({
  ...
  onLoad: function (options) {
    ...
    if (options.type=="1"){ wx.setNavigationBarTitle({ title: '支付笔数' })
      ...
      wx.setNavigationBarTitle({ title: '支付金额' }); url = "/api/admin/v1/getadminpayprice"; this.setData({ chartNameTypeControl: "支付金额" }); chartName = "付款金额（元）";
    } else if (options.type == "4") { wx.setNavigationBarTitle({ title: '提现金额' }); url = "/api/admin/v1/getadminapplicationcash"; this.setData({ chartNameTypeControl: "提现金额" }); chartName = "提现金额（元）"; }
